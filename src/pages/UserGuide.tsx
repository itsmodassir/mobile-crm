    ...
    return (
        <div className="safe-top min-h-screen pb-24 bg-background px-4 py-4 space-y-8">
            ...
            <header className="flex items-center gap-4 mb-6">
                <button
                    onClick={() => navigate(-1)}
                    className="p-2 rounded-full bg-zinc-100 text-zinc-600 hover:text-foreground transition-colors"
                >
                    <ArrowLeft size={20} />
                </button>
            ...
            <section className="space-y-4">
                <div className="flex items-center gap-2 text-primary font-bold text-lg border-b border-black/10 pb-2">
                    <Download size={20} />
                ...
                <div className="space-y-4 text-zinc-700 text-sm leading-relaxed">
                    ...
                    <div className="bg-white/50 p-4 rounded-xl border border-black/5 space-y-2">
                        <h3 className="font-bold text-foreground">Android (Chrome)</h3>
                    ...
                    <div className="bg-white/50 p-4 rounded-xl border border-black/5 space-y-2">
                        <h3 className="font-bold text-foreground">iOS (Safari)</h3>
                        <ol className="list-decimal list-inside space-y-1 text-zinc-600">
            ...
            <section className="space-y-4">
                <div className="flex items-center gap-2 text-green-400 font-bold text-lg border-b border-black/10 pb-2">
                    <Cloud size={20} />
                    <h2>Cloud Backup (Google Drive)</h2>
                </div>
                <div className="text-zinc-700 text-sm leading-relaxed space-y-3">
                    <p>
            ...
            <section className="space-y-4">
                <div className="flex items-center gap-2 text-blue-400 font-bold text-lg border-b border-black/10 pb-2">
                    <Database size={20} />
